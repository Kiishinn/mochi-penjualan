        ...
        <form action="{{ route('kepala-cabang.products.store') }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="purchase_price_display" class="form-control" value="{{ old('purchase_price') ? number_format(old('purchase_price'), 0, ',', '.') : '' }}" required oninput="formatCurrency(this, 'purchase_price')">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="selling_price_display" class="form-control" value="{{ old('selling_price') ? number_format(old('selling_price'), 0, ',', '.') : '' }}" required oninput="formatCurrency(this, 'selling_price')">
