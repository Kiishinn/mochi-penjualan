...
@section('content')
    <div class="card mb-4">
        ...
        <form action="{{ route('kepala-cabang.reports.best-sellers') }}" method="GET" class="form-grid">
            ...
            <div class="form-actions" style="grid-column: 1 / -1; margin-top: 0;">
                ...
                <a href="{{ route('kepala-cabang.reports.best-sellers') }}" class="btn btn-secondary">Reset</a>
            </div>
        </form>
    </div>
